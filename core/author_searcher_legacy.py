            ...
            for d in data:
                for page_id, page_content in d.items():
                    ...
                    for paper_id, paper_content in paper_dict.items():
                        ...
                        # 搜索2: 逐个搜索作者信息
                        prompt2 = '这是一篇论文及作者列表。请你根据这篇论文、作者名字和作者单位,去搜索该每位作者的个人信息,输出每位作者的谷歌学术累积引用(如有)、重大学术头衔(比如是否IEEE/ACM/ACL等学术Fellow、中国科学院院士、中国工程院院士、国外院士如欧洲科学院院士、诺贝尔奖得主、图灵奖得主,国家杰青、长江学者、优青,或在AI领域的国际知名人物),行政职位(如国内外知名大学的校长或院长)。'
